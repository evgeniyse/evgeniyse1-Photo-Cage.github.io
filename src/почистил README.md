(я папки почистил ,но если понадобится шрифты и css scss php и др.то можно глянуть в папке -!!!!!шаблон verstka по бему адаптивный семантический кроссбраузерный)
